							...
							{isLoading && (
								<div className="px-3">
									<div className="w-full h-fit">
										<Loader message={localization.publishingInProgress} />
									</div>
								</div>
							)}
							{showSuccess && (
								<div className="px-3">
									<Alert type="success" title={localization.publishSuccess} message={localization.publishSuccessMessage} />
								</div>
							)}
							{showError && (
								<div className="px-3">
									<Alert type="danger" title={localization.publishFailed} message={localization.publishFailedMessage} />
								</div>
							)}
