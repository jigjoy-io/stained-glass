...
export default function SizeEditor(props: any) {
    ...
    const sizes = [{text: 'Small', key: 'small'}, 
    ...
    return <div className="flex flex-col p-2">
        <div className="pb-3 w-[150px]">
            {sizes.map((size: any) => <div className="py-2"><Checkbox selected={value==size.key} onChange={() => setValue(size.key)}>{size.text}</Checkbox></div>)}
        </div>
