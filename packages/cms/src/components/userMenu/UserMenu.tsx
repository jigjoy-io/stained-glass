    ...
    return (
        <div>
            <div>
                <button
                    onClick={handleOpen}
                    className="px-4 py-3 flex items-center justify-between text-gray-800 hover:bg-black-50 transition-colors duration-200"
                >
...

                {
                    isOpen && createPortal(<ClickOutsideListener callback={handleClose}>
                        ...
                        <div className={`fixed flex rounded-md p-1 p-2 shadow bg-[white] w-[220px]`}
